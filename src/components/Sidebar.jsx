...
const Sidebar = () => {
  return (
    <>
      <div className="w-[218px] bg-blue h-screen p-2  pt-8 duration-300">
        <img
          className="w-[176px] h-[26px] mt-8 mb-[40px]"
          src={Logo}
          alt="logo"
        />
        <div className="flex flex-col justify-start  mr-10 text-left">
          <ul className="font-normal text-xl leading-[70px] text-left mr-auto">
            <li className="flex cursor-pointer items-center text-white">
              {" "}
            ...
            <li className="flex justify-start cursor-pointer items-center text-white">
              {" "}
              <div className="flex items-center mx-2">
                <img src={require("./treatments.png")} alt="treatments" />
              </div>
              Treatments
            </li>
            <li className="flex justify-start cursor-pointer items-center text-white">
              {" "}
              <div className="flex items-center mx-2 w-[20px]">
                <img src={require("./appointments.png")} alt="appointments" />
              </div>
              Appointments
            </li>
        ...
        <div className="flex text-lg absolute justify-center items-center rounded-md p-3 cursor-pointer text-white bottom-8">
          <div className="flex items-center mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
